...
```
git clone https://github.dxc.com/mv-transportation/osm-website-with-multitenancy.git
```

To clone only the most recent version (~23MB), instead use a 'shallow clone':

```
git clone --depth=1 https://github.dxc.com/mv-transportation/osm-website-with-multitenancy.git
```
