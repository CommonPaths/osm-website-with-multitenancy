OpenStreetMap::Application.routes.draw do
  ...
  #Export Reconciliation Public changeset file
  get 'recon_export/recon_export_page'
  get '/button_export', to: 'recon_export#button_export', as: 'button_export'
  get 'recon_export/download_osc'
  ...
  # reconciliation
  put "reconciliation/create" => "reconciliation#create"
  get "reconciliation/node" => "reconciliation#show"
  get "reconciliation/update" => "reconciliation#update"
  get "reconciliation/manual_false" => "reconciliation#update_manual_update_flag"
  get "reconciliation/read_last_timestamp" => "reconciliation#read_last_timestamp"

  # reconciliation_complete
  get "recon_ctrl/button" => "recon_ctrl#button"
